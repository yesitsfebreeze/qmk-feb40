...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [COMBO] = LAYOUT(
        KC_NO, KC_MS_BTN1, KC_MS_UP, KC_MS_BTN2, KC_NO, KC_F1, KC_F2, KC_F3, KC_F4, KC_NO, KC_NO, KC_NO,
        KC_RGB_SWITCH, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_NO, KC_F5, KC_F6, KC_F7, KC_F8, KC_NO, KC_ENTER,
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_NO,
