...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        KC_LCTL, KC_OS_META, KC_OS_ALT, LT(LOWER, KC_SPC), LT(RAISE, KC_SPC), RM(RM_SLASH_BACKSLASH), RM(RM_MNS_PLS), RM(RM_UNDS)
    ),
    [LOWER] = LAYOUT(
        ...
        KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT, RM(RM_LPRN), RM(RM_RPRN), KC_NO, KC_NO, KC_SCLN, RM(RM_QUOT_SQUOT), KC_BSPC,
    ...
    [RAISE] = LAYOUT(
        ...
        RM(RM_DOT_COMMA), KC_4, KC_5, KC_6, RM(RM_LPRN), RM(RM_RPRN), KC_NO, KC_NO, KC_SCLN, RM(RM_QUOT_SQUOT), KC_BSPC,
    ...
    [COMBO] = LAYOUT(
        ...
        KC_TRNS, KC_REMOTE_SWITCH, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, QK_BOOT
    ),
};