...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LOWER] = LAYOUT(
    _______,  CK_HOME,  KC_UP,    CK_END,   CK_LBRC,  CK_RBRC,  _______,  CK_AMPR,  CK_PIPE,  _______,  MA_OR,    _______,
    _______,  KC_LEFT,  KC_DOWN,  KC_RIGHT, CK_LPRN,  CK_RPRN,  _______,  _______,  KC_SCLN,  CK_QUOT,  KC_BSPC,
    _______,  C(KC_Z),  C(KC_X),  C(KC_C),  C(KC_V),  _______,  _______,  KC_TILDE, _______,  _______,  _______,
    _______,  _______,  _______,  _______,                      L_COMBO,            _______,  _______,  _______
  ),
  [RAISE] = LAYOUT(
    _______,  KC_1,     KC_2,     KC_3,     _______,  _______,  _______,  CK_AMPR,  CK_PIPE,  _______,  _______,  _______,
    KC_0,     KC_4,     KC_5,     KC_6,     _______,  _______,  _______,  _______,  KC_SCLN,  _______,  KC_BSPC,
    KC_LSFT,  KC_7,     KC_8,     KC_9,     _______,  _______,  _______,  KC_TILDE, _______,  _______,  _______,
  ...
  [COMBO] = LAYOUT(
    ...
    KC_LSFT,  KC_WH_U,  KC_MB3,   KC_WH_D,  KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   _______,
