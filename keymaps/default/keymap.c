...
// QK_KB_3 - QK_KB_31 and QK_USER_0 - QK_USER_31
#define MA_OR    QK_KB_3
#define MA_AND   QK_KB_4
#define MA_PTR   QK_KB_5
#define KC_SENT  QK_KB_6
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE]  = LAYOUT(
    ...
    KC_LCTL,  KC_LWIN,  KC_LALT,            L_LWR,              L_RSE,                        KC_SLASH, KC_MINS,  KC_UNDS
  ),
  [LOWER] = LAYOUT(
    ...
    _______,  _______,  _______,            _______,            L_CMB,                        _______,  _______,  _______
  ),
  [RAISE] = LAYOUT(
    ...
    _______,  _______,  _______,            L_CMB,              _______,                      _______,  _______,  _______
  ),
  [COMBO] = LAYOUT(
